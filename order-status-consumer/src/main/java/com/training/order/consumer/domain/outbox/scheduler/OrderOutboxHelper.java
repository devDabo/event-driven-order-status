package com.training.order.consumer.domain.outbox.scheduler;
...
import com.training.order.consumer.domain.ports.output.repository.OrderOutboxRepository;
...
public class OrderOutboxHelper {
    ...
    private String createPayload(OrderEventPayload orderEventPayload) {
        try {
            ...
            throw new PaymentApplicationServiceException("Could not create OrderEventPayload json!", e);
        }
    }
    ...
    private void save(OrderOutboxMessage orderOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new PaymentApplicationServiceException("Could not save OrderOutboxMessage!");
        }
