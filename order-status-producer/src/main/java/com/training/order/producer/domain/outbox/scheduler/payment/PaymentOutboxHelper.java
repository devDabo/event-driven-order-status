package com.training.order.producer.domain.outbox.scheduler.payment;
...
public class PaymentOutboxHelper {
    ...
    private static final String ORDER_SAGA_NAME = "ORDER_SAGA";
    ...
    public void save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new IllegalStateException("Could not save OrderPaymentOutboxMessage with outbox id: " + orderPaymentOutboxMessage.getId());
        }
    ...
    private String createPayload(OrderPaymentEventPayload paymentEventPayload) {
        try {
            ...
            throw new IllegalStateException("Could not create OrderPaymentEventPayload object for order id: " +
                    paymentEventPayload.getOrderId(), e);
        }
    }
}
