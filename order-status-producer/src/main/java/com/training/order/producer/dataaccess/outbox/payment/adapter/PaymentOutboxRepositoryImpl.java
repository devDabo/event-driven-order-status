package com.training.order.producer.dataaccess.outbox.payment.adapter;

import com.training.order.producer.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import com.training.order.producer.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
import com.training.order.producer.domain.outbox.model.payment.OrderPaymentOutboxMessage;
import com.training.order.producer.domain.ports.output.repository.PaymentOutboxRepository;
...
public class PaymentOutboxRepositoryImpl implements PaymentOutboxRepository {
    ...
    public Optional<List<OrderPaymentOutboxMessage>> findByTypeAndOutboxStatusAndSagaStatus(String sagaType,
        ...
        return paymentOutboxJpaRepository.findByTypeAndOutboxStatusAndSagaStatusIn(sagaType, outboxStatus,
