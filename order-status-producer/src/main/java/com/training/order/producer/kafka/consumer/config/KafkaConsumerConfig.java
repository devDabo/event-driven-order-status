package com.training.order.producer.kafka.consumer.config;

import com.training.order.producer.kafka.config.data.KafkaConfigData;
import com.training.order.producer.kafka.config.data.KafkaConsumerConfigData;
